...
const PrintBill = () => {
  ...
  // const PrintBill = ({ products, orderData }) => {
  console.log("STATEMENT", JSON.stringify(orderData, null, 2));
  ...
  const handleDownload = (e) => {
    ...
    const options = {
      ...
      jsPDF: {
        unit: 'mm',
        format: [80, contentHeight / 3], // Dynamic height
    ...
    if (printRef.current) {
      ...
      iframeDocument.write(`
            ...
            <head>
                ...
                <style>
                    @media print {
                        ...
                        /* Target ONLY the #bill-content within the iframe */
                        #bill-content {
                            width: 80mm; /* Or whatever width you need */
                            box-sizing: border-box;
                            /* ... other styles for #bill-content ... */
                        }

                        /* Target table styles INSIDE #bill-content */
                        #bill-content table {
                            width: 100%;
                        ...
                        /* ... and so on for ALL other elements INSIDE #bill-content */
                        #bill-content .text-end { text-align: right; }
                        #bill-content .text-center { text-align: center; }
                        #bill-content .footer-text { margin-top: 10px; }
                        #bill-content .header-text { font-size: 1.2em; font-weight: bold; margin-bottom: 8px; }
                        #bill-content .shop-title { font-size: 1.4em; font-weight: bold; margin-bottom: 0px; }
                        #bill-content .shop-details {font-size: 1.2em;  margin-bottom: 10px; white-space: pre-wrap;}
                        #bill-content .small-text { font-size: 1.0em; }
                        #bill-content .bill-info { margin-bottom: 8px;}

                        /* Footer style */
                        .footer-text {
                          text-align: center; /* or whatever alignment */
            ...
            <body>
                ...
                <p class="footer-text">Savor the flavor! Thanks for visiting!</p>  
                <script>
                    window.addEventListener('load', function() {
                        window.print();
                        // Optional: Remove the iframe after printing (if needed)
  ...
  return (
    <div className='mt-5 row d-flex justify-content-center'>
      ...
      <div className="col-12 mb-2 d-flex justify-content-center">
        <button className="btn btn-sm btn-primary" onClick={handlePrint}> {/* <-- Pass orderData */}
          Print
        </button>
      </div>
