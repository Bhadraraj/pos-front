...
// const PrintBill = () => {
//   const orderData = JSON.parse(sessionStorage.getItem('orderData') || '{}'); // Retrieve from sessionStorage
//   sessionStorage.removeItem('orderData'); // Clear after use - important!
...
const PrintBill = () => {
  ...
  const handlePrint = (e) => {
    ...
    if (printRef.current) {
      ...
      const printWindow = document.createElement('div'); // Create a div for printing
      printWindow.innerHTML = printContents;

      // Apply print styles directly (essential for consistent printing):
      ...
      document.body.appendChild(printWindow); // Add to the DOM

      window.print(); // Trigger the print dialog

      document.body.removeChild(printWindow); // Remove from the DOM after printing
    }
  };
